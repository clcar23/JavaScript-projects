...
function placeXOrO(squareNumber) {
    ...
    function checkWinConditions() {
        ...
        //This function checks if an array includes 3 strings. Ith is used to check for 
        //each win condition.
        function arrayIncludes(squareA, squareB, squareC) {
            //These 3 varaiables will be used to check for 3 in a row.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function clear() {
        //This line starts out animation loop.
