...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        Calculator.Display_Value = Display_Value === '0' ? digit : Display_Value + digit;//'?' is the conditional operator, gives the choice of digit or(:) Display_Value + digit
...
function Input_Decimal (dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) { //'!' the bang operator
